...
import 'package:whatsapp_clone/utils/videoplayer.dart';
        ...
        children: [
          ...
          Row(
            children: <Widget>[
              IconButton(
                  onPressed: () async {
                    await AuthMethods().likepost(FirebaseAuth.instance.currentUser!.uid, widget.snap['postId'], widget.snap['likes']);
                  },
